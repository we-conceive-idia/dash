...
git clone https://github.com/wikipay/wiki
```
...
```bash
    ...
    From https://github.com/wikipay/wiki
...
BTCPATH=/some/root/path/wiki.git
SIGPATH=/some/root/path/wiki-detached-sigs.git

./bin/gbuild --url wiki=${BTCPATH},signature=${SIGPATH} ../wiki/contrib/gitian-descriptors/gitian-win-signer.yml
```
...
[wiki/gitian.sigs](https://github.com/wikipay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
