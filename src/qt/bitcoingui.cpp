    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Wiki Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Wiki Core"), this);
    aboutAction->setStatusTip(tr("Show information about Wiki Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Wiki Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Wiki Core help message to get a list with possible Wiki Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Wiki Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Wiki Core"); // default title
